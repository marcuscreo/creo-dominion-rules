Feature: Sort Participants by the order they will act on a turn
  ...
  Scenario: Gavin vs. Brutus vs. Groth
    Given a combat round is starting
      And "Gavin" joins the combat round with a "timing" attribute of "6"
      And "Brutus" joins the combat round with a "timing" attribute of "3"
      And "Groth" joins the combat round with a "timing" attribute of "4"
